...
//      - Biomont SL Reporte Bonificacion x Descto (customscript_bio_sl_rep_bonxdescto)
        ...
        const onRequest = (scriptContext) => {
            if (scriptContext.request.method == 'GET') {
                ...
                switch (ServerWidget.selectedReport()) {
                    case Basic.DATA.Report.BONIFICACION_DESCUENTO: {
                        log.debug('Start Report', '---- Presentacion Detallada ----')
                        // selectedReportHtml = 'prueba';
                        selectedReportHtml = new ReportManager.BonificacionDescuento(params).print();
                ...
                if (params.xls == 'T') {
                    ...
                    scriptContext.response.writeFile(
                        file.create({
                            name: 'biomont_reporteBonificacionDescuento.xls',
